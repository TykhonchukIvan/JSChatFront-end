...
export const creatureText = array => {
    ...
    array.forEach(object => {
        ...
        object.maxlength && (textarea.setAttribute('maxlength', object.maxlength));
...
export const creatureInput = array =>{
    ...
    array.forEach(object => {
        ...
        object.required && (contentInput.required = 'required');
        object.placeholder && (contentInput.placeholder = object.placeholder);
        object.placeholder && (contentInput.placeholder = object.placeholder);
        object.type && (contentInput.setAttribute('type', object.type));
